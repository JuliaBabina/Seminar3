...
## Просмотр истории коммитов (дополнение)

При добавлении опции --graph выводится история ветвлений и слияний (их визуализация).

    git log --oneline --all -- graph

![Что выводит команда graph](git_graph.png)

## Повторим про Git checkout (для лучшего понимания)
